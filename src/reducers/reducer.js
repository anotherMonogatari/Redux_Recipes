const initState = {
	"recipe": [
		...
		},
		{
			...
			"image": "https://www.bbcgoodfood.com/sites/default/files/styles/recipe/public/recipe/recipe-image/2018/05/caesar-salad.jpg?itok=cNYFcr8y",
			"ingredient": [
				{
					"amount": "0.5",
					"unit": "Head",
		...
		},
		{
			...
			"step": [
				{
					"description": "Cut each strip of bacon into 4mm."
				},
				{
		...
		},
		{
			...
			"image": "https://i2.wp.com/www.thepersianfusion.com/wp-content/uploads/2016/07/IMG_3002.jpg?fit=2048%2C1536&ssl=1",
			"tag": [
				"Stew",
				"Persian",
				"Beef"
...
const reducer = (state = initState, action) => {
    if (action.type === 'FILTER') {
        const filteredState = initState.recipe.filter(recipe => recipe.name.toLowerCase().indexOf(action.payload) > -1)
        return {
            recipe: filteredState            
        }
    }
